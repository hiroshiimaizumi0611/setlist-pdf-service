...
CREATE INDEX `subscription_customer_id_idx` ON `subscription` (`stripe_customer_id`);--> statement-breakpoint
CREATE INDEX `subscription_subscription_id_idx` ON `subscription` (`stripe_subscription_id`);--> statement-breakpoint
